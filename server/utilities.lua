...
SS_Utils = {
    ...
    ---@param columns string should look something like this  --> "(id INT AUTO_INCREMENT, PRIMARY KEY(id))"
    CheckForDBTable = function(table, columns)
        MySQL.query("SHOW TABLES LIKE '"..table.."';", {}, function(result)
            if result and #result > 0 then
                ...
                MySQL.query("CREATE TABLE IF NOT EXISTS "..table.." "..columns..";")
